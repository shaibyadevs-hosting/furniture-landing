  ...
  return (
    ...
    >
      ...
      {heroImages.map((image, index) => (
        <div
          key={index}
          className={`hero-carousel-bg absolute inset-0 transition-opacity duration-[3000ms] ease-in-out ${
        ...
        {heroImages.map((_, index) => (
          <button
            ...
            className={`h-1.5 rounded-full transition-all duration-500 ${
              index === currentImageIndex ? 'w-12 bg-gray-800' : 'w-4 bg-gray-400 hover:bg-gray-600'
            }`}
