...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-600 via-slate-700 to-slate-800">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center pt-20 pb-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 leading-tight px-4">
          Crafting <span className="text-blue-400">Comfort</span> <span className="text-white">&</span> <span className="text-blue-400">Elegance</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 mb-12 sm:mb-16 px-4">
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-2 border-white text-white hover:bg-white hover:text-slate-800 px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-semibold rounded-md transition-all w-full sm:w-auto"
          >
            Contact Us
          </Button>
        </div>
