    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-blue-100 to-blue-200 p-6 sm:p-8 lg:p-12 min-h-[250px] sm:min-h-[300px] flex flex-col justify-center">
            ...
            <div className="relative z-10">
              <p className="text-xs sm:text-sm font-semibold text-blue-800 mb-2">Up to 25% Discount</p>
          ...
          <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-slate-700 to-slate-900 p-6 sm:p-8 lg:p-12 min-h-[250px] sm:min-h-[300px] flex flex-col justify-center">
            <div className="absolute right-0 top-0 w-1/2 h-full opacity-20">
            ...
            <div className="relative z-10">
              <p className="text-xs sm:text-sm font-semibold text-green-400 mb-2">20% Diwali Discount</p>
